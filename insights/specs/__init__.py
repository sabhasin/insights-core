...
class Specs(SpecSet):
    ...
    abrt_status_bare = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    alternatives_display_python = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    auditctl_rules = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    auditctl_status = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    cciss = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    certificates_enddate = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    cgroups = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    checkin_conf = RegistryPoint()
    chkconfig = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    cloud_init_query = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    cpe = RegistryPoint()
    cpu_cores = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    cpu_siblings = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    cpu_smt_active = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    cpu_smt_control = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    cpu_vulns = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    crt = RegistryPoint()
    crypto_policies_bind = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    crypto_policies_config = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    crypto_policies_opensshserver = RegistryPoint()
    crypto_policies_state_current = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    cryptsetup_luksDump = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    cupsd_conf = RegistryPoint()
    cups_browsed_conf = RegistryPoint(filterable=True)
    cups_files_conf = RegistryPoint()
    cups_ppd = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    current_clocksource = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    date = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    date_utc = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    db2_database_configuration = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    db2_database_manager = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    db2ls_a_c = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    dotnet_version = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    etc_machine_id = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    ethtool = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ethtool_S = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ethtool_T = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ethtool_a = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ethtool_c = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    falconctl_rfm = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    falconctl_version = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    fapolicyd_rules = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    fc_match = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    flatpak_list = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    gcp_instance_type = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    gcp_license_codes = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    gcp_network_interfaces = RegistryPoint()
    getcert_list = RegistryPoint()
    getconf_page_size = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    getenforce = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    getsebool = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    group_info = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    grub1_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    grub2_cfg = RegistryPoint()
    grub2_efi_cfg = RegistryPoint()
    grub_conf = RegistryPoint()
    grub_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    heat_crontab = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    heat_engine_log = RegistryPoint(filterable=True)
    hostname = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    hostname_default = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    hostname_short = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    hosts = RegistryPoint()
    hponcfg_g = RegistryPoint()
    httpd24_httpd_error_log = RegistryPoint(filterable=True)
    httpd_M = RegistryPoint(multi_output=True)
    httpd_V = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    httpd_access_log = RegistryPoint(filterable=True)
    httpd_cert_info_in_nss = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['ipv4', 'ipv6', 'mac']
    )
    ...
    ibm_fw_vernum_encoded = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ibm_lparcfg = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ifcfg = RegistryPoint(multi_output=True)
    ifcfg_static_route = RegistryPoint(filterable=True, multi_output=True)
    ilab_config_show = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ilab_model_list = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    imagemagick_policy = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['ipv4', 'ipv6', 'mac']
    )
    image_builder_facts = RegistryPoint()
    init_ora = RegistryPoint()
    init_process_cgroup = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    initctl_lst = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    initscript = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    insights_client_conf = RegistryPoint(filterable=True)
    installed_rpms = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    interrupts = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    ipcs_m = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ipcs_m_p = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ipcs_s = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ipcs_s_i = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    iris_list = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    keystone_crontab = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    limits_conf = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    locale = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    localectl_status = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    localtime = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    login_pam_conf = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    logrotate_conf = RegistryPoint(multi_output=True)
    losetup = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    lpfc_max_luns = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    # ^ End of ls
    lsattr = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    lspci_vmmkn = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    lssap = RegistryPoint()
    ...
    manila_conf = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    mariadb_log = RegistryPoint(filterable=True)
    max_uid = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    mlx4_port = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    modinfo_filtered_modules = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    modinfo_modules = RegistryPoint(
        filterable=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    ...
    mpirun_version = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    mssql_api_assessment = RegistryPoint()
    mssql_conf = RegistryPoint()
    mssql_tls_cert_enddate = RegistryPoint()
    multicast_querier = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    nmcli_conn_show = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    nova_uid = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    nvidia_smi_query_gpu = RegistryPoint(no_obfuscate=['hostname', 'ipv4'])
    numa_cpus = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    numeric_user_group_name = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    nvidia_smi_active_clocks_event_reasons = RegistryPoint(
        no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    nvidia_smi_l = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    nvidia_smi_query_gpu = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    nvme_core_io_timeout = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    od_cpu_dma_latency = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    os_release = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    pmlog_summary_pcp_zeroconf = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    proc_keys = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    proc_keyusers = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    proc_netstat = RegistryPoint()
    proc_slabinfo = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    proc_snmp_ipv4 = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    proc_snmp_ipv6 = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    proc_stat = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    puppet_ca_cert_expire_date = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    ql2xmqsupport = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    repquota_agnpuv = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    rhsm_releasever = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    rhui_releasever = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    rhui_set_release = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    route = RegistryPoint()
    rpm_V_package = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    rpm_V_package_list = RegistryPoint(filterable=True)
    rpm_ostree_status = RegistryPoint()
    rpm_pkgs = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    rsyslog_conf = RegistryPoint(filterable=True, multi_output=True)
    rsyslog_tls_ca_cert_enddate = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    rsyslog_tls_cert_enddate = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    saphostexec_status = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    saphostexec_version = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    sat5_insights_properties = RegistryPoint()
    satellite_compute_resources = RegistryPoint()
    satellite_content_hosts_count = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    satellite_host_facts_count = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    satellite_katello_repos_with_muliple_ref = RegistryPoint()
    satellite_logs_table_size = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    satellite_revoked_cert_count = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    satellite_rhv_hosts_count = RegistryPoint()
    satellite_sca_status = RegistryPoint()
    satellite_settings = RegistryPoint()
    satellite_version_rb = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    scsi_mod_max_report_luns = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    scsi_mod_use_blk_mq = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    sctp_asc = RegistryPoint()
    sctp_eps = RegistryPoint()
    sctp_snmp = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    sestatus = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    setup_named_chroot = RegistryPoint(
        filterable=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    ...
    sockstat = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    softnet_stat = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    software_collections_list = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    sshd_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    sys_vmbus_device_id = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    ...
    tty_console_active = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    uname = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    up2date = RegistryPoint(filterable=True)
    up2date_log = RegistryPoint(filterable=True)
    uptime = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    vdsm_id = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    vhost_net_zero_copy_tx = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    virsh_list_all = RegistryPoint()
    virt_uuid_facts = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    virt_what = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
    ...
    yum_list_available = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    yum_list_installed = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    yum_log = RegistryPoint(filterable=True, no_obfuscate=['ipv4', 'ipv6', 'mac'])
    yum_repolist = RegistryPoint()
    yum_repos_d = RegistryPoint(multi_output=True)
    yum_updateinfo = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    yum_updates = RegistryPoint(no_obfuscate=['ipv4', 'ipv6', 'mac'])
    zdump_v = RegistryPoint()
    zipl_conf = RegistryPoint()

    # container_specs
    container_cpu_online = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    container_cpuset_cpus = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    container_dotnet_version = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    ...
    container_redhat_release = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac']
    )
    container_vsftpd_conf = RegistryPoint(multi_output=True, filterable=True)
    containers_inspect = RegistryPoint(no_obfuscate=['hostname', 'ipv4', 'ipv6', 'mac'])
